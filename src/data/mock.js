...
export const SUGGESTED_PRODUCTS = [...NEW_ARRIVALS, ...WEEKLY_EDIT_GRID];

// ---------------------------------------------------------------------------
// ALL_PRODUCTS — รวมสินค้าทั้งหมด สำหรับ hook ที่ต้องการ sort by date
// (อนาคตแทนด้วย API call ตรงนี้)
// ---------------------------------------------------------------------------
